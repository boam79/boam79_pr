...
import { ArrowRight, Wrench, Award, Cpu } from 'lucide-react';

export default function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-zinc-200/80 bg-zinc-50">
      <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6 sm:py-24 md:px-8 lg:max-w-6xl lg:py-28">
            ...
            <dl className="mt-10 grid max-w-xl grid-cols-1 gap-6 border-t border-zinc-200 pt-10 sm:grid-cols-3 sm:gap-8">
              <div>
                <dt className="flex items-center gap-1.5 text-xs font-medium text-zinc-500">
                  <Wrench className="h-3.5 w-3.5 text-teal-600" aria-hidden />
                  시설관리
                </dt>
              ...
              <div>
                <dt className="flex items-center gap-1.5 text-xs font-medium text-zinc-500">
                  <Cpu className="h-3.5 w-3.5 text-blue-600" aria-hidden />
                  참여
                </dt>
